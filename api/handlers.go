...
func InitDB() {
	...
	// Migrate the schema
	if err = DB.AutoMigrate(&User{}, &VerificationCode{}, &Country{}, &State{}, &Gender{}, &DriverProfile{}, &VehicleType{}, &Category{}, &LoadType{}, &DriverLoadType{}, &DriverVehicleType{}, &UserLocation{}, &Order{}, &OrderEventLog{}); err != nil {
